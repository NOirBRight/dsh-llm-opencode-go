...
dsh plugin --profile web add --force \
  https://github.com/NOirBRight/dsh-llm-opencode-go/releases/download/v0.1.23/dsh-llm-opencode-go-0.1.23.tgz
dsh web
~~~
...
Release and integrity: [v0.1.23](https://github.com/NOirBRight/dsh-llm-opencode-go/releases/tag/v0.1.23) · [SHA256SUMS](https://github.com/NOirBRight/dsh-llm-opencode-go/releases/download/v0.1.23/SHA256SUMS).
