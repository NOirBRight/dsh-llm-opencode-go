window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_8c36cc947c66a0f004f8c9864f194e4b/node_modules/dsh-llm-providers-ui/lib/usage-readers.js
		...
		function policyFor(model) {
			return MODEL_POLICIES[model.toLowerCase()] ?? FAMILIES[familyForModel(model)] ?? {
				levels: GENERIC,
				defaultEffort: "medium"
			};
		}
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_8c36cc947c66a0f004f8c9864f194e4b/node_modules/dsh-llm-providers-ui/lib/sortable.js
		...
		*/
		...
		const en = {
			...
			usageIdle: "Click Refresh to load subscription usage. Saving does not fetch it.",
		...
		function installProviderDirectory(ctx) {
			ctx.inject(["providerDirectory"], (scope) => {
				...
				}), "dsh-llm-opencode-go: provider directory registration");
			});
		}
