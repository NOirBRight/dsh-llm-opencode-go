window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function ModelDetailRow({ children }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				style: rowStyle$1,
				children
			});
		}
		function Capabilities({ children }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { style: meterKnobStyle$1 })
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: props.title }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ProviderRoleBadge$1, { ...props.role === void 0 ? {} : { role: props.role } })]
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					...
					quota === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ProviderQuotaMeter$1, { ...quota })
					}),
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@file+..+..+..+..+.dsh-lab+tmp+dsh-llm-providers-ui-0.1.12-preview._6a05ae45ba3eb45b6a81b8389b214c50/node_modules/dsh-llm-providers-ui/lib/provider-detail.js
...
`;
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@file+..+..+..+..+.dsh-lab+tmp+dsh-llm-providers-ui-0.1.12-preview._6a05ae45ba3eb45b6a81b8389b214c50/node_modules/dsh-llm-providers-ui/lib/sortable.js
		...
		*/
		...
		function headlineQuota(usage, lastUsage, t) {
			...
			if (window !== void 0) return {
				label: weekly !== void 0 ? t("usageWeekly") : monthly !== void 0 ? t("usageMonthly") : t("usageSession"),
				remainingPercent: remainingPercent(window.usage),
				...(() => {
					const detail = resetDetail(window.resetsAt, t);
					return detail === void 0 ? {} : { detail };
				})()
			};
				...
				renderItem: (model, index) => {
					...
					return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							expanded ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(ModelDetail, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ModelDetailRow, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
								style: fieldStyle,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									style: labelStyle,
							...
							}) }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Capabilities, { children: [
		...
		function apply(ctx) {
			...
			Promise.resolve().then(readManagement).catch(() => void 0);
			const saveConfiguration = async (settings, apiKey) => {
				if (apiKey !== void 0) await storeApiKey(apiKey);
				const current = scope.getSnapshot();
				if (current.revision === void 0) throw new Error(t("requestFailed"));
			...
			ctx.inject(["providerDirectory"], (directoryScope) => {
				...
				directoryScope.effect(() => directory.register({
					key: OPENCODE_GO_SETTINGS_NAMESPACE,
					name: "OpenCode Go",
					role: "llm",
					header: "shared",
