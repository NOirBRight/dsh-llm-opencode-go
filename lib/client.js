window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region ../../compat-dsh-peer-star/dsh-llm-opencode-go/node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_d59cb640c9c5cd2b4a6e9ee7ae727515/node_modules/dsh-llm-providers-ui/lib/provider-ui.js
		...
		*/
		...
		//#endregion
		//#region ../../compat-dsh-peer-star/dsh-llm-opencode-go/node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_d59cb640c9c5cd2b4a6e9ee7ae727515/node_modules/dsh-llm-providers-ui/lib/sortable.js
		...
		*/
		...
		function apply(ctx) {
			...
			const publishAccount = (state) => {
				...
				account.state = state;
				try {
					ctx.get("providerDirectory")?.update(OPENCODE_GO_SETTINGS_NAMESPACE);
				} catch {}
			};
			...
			ctx.effect(() => {
				Promise.resolve().then(readManagement).catch(() => {
					updateSnapshot({
						...scope.getSnapshot(),
						status: "unavailable"
					});
