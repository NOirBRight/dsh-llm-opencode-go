	...
	factory: (require) => {
		...
		*/
		...
		function headlineQuotaOf(view, t) {
			...
			const label = view?.monthly !== void 0 ? t("usageMonthly") : view?.weekly !== void 0 ? t("usageWeekly") : t("usageSession");
		...
		function OpenCodeGoPluginCard(props) {
			...
			const headerQuota = credential?.configured === false || usage.status === "error" || usage.status === "unsupported" || usage.status === "needs-restart" ? void 0 : liveQuota ?? headerQuotaFromCache(peekCachedUsage("llm-opencode-go"));
