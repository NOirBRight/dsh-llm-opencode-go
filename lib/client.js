window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@0.1.1/node_modules/dsh-llm-providers-ui/lib/sortable.js
		...
		function OpenCodeGoPluginCard(props) {
			...
			const patchModel = (index, patch) => {
				...
				patchDraft({ models: draft.models.map((model, at) => {
					...
					if (patch.id !== void 0) {
						next.id = patch.id;
						if (next.thinking === true && next.defaultEffort !== void 0 && !isValidEffortForModel({
							id: next.id,
							thinking: true
						}, next.defaultEffort)) {
					...
					if ("thinking" in patch) {
						...
						else if (next.defaultEffort === void 0 || !isValidEffortForModel({
							id: next.id,
							thinking: true
						}, next.defaultEffort)) {
							const fallback = resolveEffectiveDefaultEffort({
												...
												expanded ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(ModelDetail, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ModelDetailRow, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
													...
													model.thinking === true ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
														...
														children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
															...
															children: openCodeGoSupportedEfforts({
																id: model.id,
																thinking: true
