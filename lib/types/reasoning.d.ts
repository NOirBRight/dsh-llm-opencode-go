...
export declare function canonOpenCodeGoEffort(value: string): ModelThinkingLevel | undefined;
/** Supported thinking levels for one catalog row, in canonical order. */
export declare function openCodeGoSupportedEfforts(model: Pick<OpenCodeGoCatalogModelConfig, 'id' | 'thinking' | 'thinkingEfforts'>): readonly ModelThinkingLevel[];
...
export declare function resolveEffectiveDefaultEffort(model: Pick<OpenCodeGoCatalogModelConfig, 'id' | 'thinking' | 'thinkingEfforts'> & {
    defaultEffort?: string;
}): ModelThinkingLevel | undefined;
/** Whether an explicit effort is valid for the model's family. */
export declare function isValidEffortForModel(model: Pick<OpenCodeGoCatalogModelConfig, 'id' | 'thinking' | 'thinkingEfforts'>, effort: string): boolean;
