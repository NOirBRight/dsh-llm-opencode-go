...
export declare const en: {
    ...
    readonly apiKeyConfigured: "Configured";
    readonly apiKeyReplace: "Enter a new key to replace the saved key";
    ...
    readonly baseURLHint: "Official OpenCode Go endpoint.";
    readonly connection: "Connection";
    readonly usage: "Account quota";
    readonly usageRefresh: "Refresh";
    readonly usageIdle: "Save an API key to load account quota.";
    readonly usageLoading: "Reading usage…";
    readonly usageSession: "5-hour window";
    readonly usageWeekly: "Weekly window";
    readonly usageMonthly: "Monthly window";
