...
export class OpenCodeGoModelPickerController {
  private snapshot: OpenCodeGoModelPickerSnapshot = {
    open: false,
    loading: false,
    candidates: [],
    picked: new Set(),
  ...
  getSnapshot = (): OpenCodeGoModelPickerSnapshot => this.snapshot
  ...
  private publish(snapshot: OpenCodeGoModelPickerSnapshot): void {
