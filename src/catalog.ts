...
const KNOWN: readonly OpenCodeGoKnownModel[] = [
  ...
  { id: 'gpt-5.6-luna', name: 'GPT 5.6 Luna', contextWindow: 1_050_000, maxTokens: 128_000, api: 'openai-responses', vision: true, thinking: true, defaultEffort: 'medium', family: 'gpt' },
  { id: 'muse-spark-1.2-contributor', name: 'Muse Spark 1.2 Contributor', contextWindow: 1_048_576, maxTokens: 131_072, api: 'openai-responses', vision: true, thinking: true, defaultEffort: 'medium', family: 'muse' },
  ...
  { id: 'kimi-k2.5', name: 'Kimi K2.5', contextWindow: 262_144, maxTokens: 65_536, api: 'openai-completions', vision: true, thinking: true, defaultEffort: 'medium', family: 'kimi' },
  { id: 'longcat-2.0', name: 'LongCat-2.0', contextWindow: 1_000_000, maxTokens: 131_072, api: 'openai-completions', vision: false, thinking: true, defaultEffort: 'medium', family: 'longcat' },
  { id: 'deepseek-v4-pro', name: 'DeepSeek V4 Pro', contextWindow: 1_000_000, maxTokens: 384_000, api: 'openai-completions', vision: false, thinking: true, defaultEffort: 'high', family: 'deepseek' },
  { id: 'deepseek-v4-flash', name: 'DeepSeek V4 Flash', contextWindow: 1_000_000, maxTokens: 384_000, api: 'openai-completions', vision: false, thinking: true, defaultEffort: 'high', family: 'deepseek' },
  { id: 'deepseek-v4-flash-vision-exp', name: 'DeepSeek V4 Flash Vision Exp', contextWindow: 1_000_000, maxTokens: 384_000, api: 'openai-completions', vision: true, thinking: true, defaultEffort: 'high', family: 'deepseek' },
  { id: 'mimo-v2.5', name: 'MiMo-V2.5', contextWindow: 1_000_000, maxTokens: 128_000, api: 'openai-completions', vision: true, thinking: true, defaultEffort: 'medium', family: 'mimo' },
  { id: 'mimo-v2.5-pro', name: 'MiMo-V2.5-Pro', contextWindow: 1_048_576, maxTokens: 128_000, api: 'openai-completions', vision: false, thinking: true, defaultEffort: 'medium', family: 'mimo' },
  { id: 'mimo-v2-pro', name: 'MiMo-V2-Pro', contextWindow: 1_048_576, maxTokens: 131_072, api: 'openai-completions', vision: false, thinking: true, defaultEffort: 'medium', family: 'mimo' },
  { id: 'mimo-v2-omni', name: 'MiMo-V2-Omni', contextWindow: 262_144, maxTokens: 65_536, api: 'openai-completions', vision: true, thinking: true, defaultEffort: 'medium', family: 'mimo' },
  ...
  { id: 'minimax-m3', name: 'MiniMax M3', contextWindow: 1_000_000, maxTokens: 131_072, api: 'anthropic-messages', vision: true, thinking: false, family: 'minimax' },
  { id: 'minimax-m2.7', name: 'MiniMax M2.7', contextWindow: 204_800, maxTokens: 131_072, api: 'anthropic-messages', vision: false, thinking: false, family: 'minimax' },
  { id: 'minimax-m2.5', name: 'MiniMax M2.5', contextWindow: 196_608, maxTokens: 131_072, api: 'anthropic-messages', vision: false, thinking: false, family: 'minimax' },
